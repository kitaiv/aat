...
<!-- AdminLTE -->
<script src="<? $_SERVER[DOCUMENT_ROOT] ?>/aat/admin/adminPanel/dist/js/adminlte.js"></script>

<!-- OPTIONAL SCRIPTS -->
<script src="<? $_SERVER[DOCUMENT_ROOT] ?>/aat/admin/adminPanel/plugins/chart.js/Chart.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<? $_SERVER[DOCUMENT_ROOT] ?>/aat/admin/adminPanel/dist/js/demo.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<? $_SERVER[DOCUMENT_ROOT] ?>/aat/admin/adminPanel/dist/js/pages/dashboard3.js"></script>
</body>
</html>
